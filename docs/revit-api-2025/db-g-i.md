...
Implements: IDisposable
  ...
  CONSTRUCTORS:
    new GBXMLExportOptions(IList<ElementId> massZoneIds, IList<ElementId> massIds)
      Description: Constructs a new instance of the options used to export a mass model to gbXML.
      @massZoneIds: Indicates the mass zones to analyze in the exported gbXML.
      @massIds: Indicates the masses to use as shading surfaces in the exported gbXML--these masses must not have mass floors or mass zones so as not to end up with duplicate surface information in the gbXML output.
      Throws ArgumentNullException: A non-optional argument was null
    new GBXMLExportOptions()
      Description: Constructs a new instance of the options used to export a model in gbXML (green-building) format.
...
Inherits: DatumPlane
  ...
  METHODS:
    static Grid Create(Document document, Arc arc)
      ...
      Throws ArgumentException: document is not a project document. -or- The input arc is not on horizontal plane.
      Throws ArgumentNullException: A non-optional argument was null
    static Grid Create(Document document, Line line)
      ...
      Returns: The newly created grid line.
      Throws ArgumentException: document is not a project document. -or- The input line is not on horizontal plane.
      Throws ArgumentNullException: A non-optional argument was null
    Outline GetExtents()
...
Remarks: ImageType elements are created with the ImageType.Create(Document, ImageTypeOptions) method.ImageType elements can be loaded from the following file types: *.bmp, *.jpg, *.jpeg, *.png, *.tif.In addition, when PDF support is available, ImageType elements can also be loaded from *.pdf files. See: IsPDFImportAvailable
Inherits: ElementType
