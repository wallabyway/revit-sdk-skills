...
Inherits: Element
  ...
  METHODS:
    ...
    IList<Curve> GetCenterlineCurves(bool adjustForSelfIntersection, bool suppressHooks, bool suppressBendRadius, MultiplanarOption multiplanarOption, int barPositionIndex)
      ...
      Throws ArgumentOutOfRangeException: barPositionIndex is not in the range [ 0, NumberOfBarPositions-1 ]. -or- A value passed for an enumeration argument is not a member of that enumeration
    ...
    RebarHookOrientation GetHookOrientation(int iEnd)
      ...
      Throws ArgumentOutOfRangeException: iEnd must be 0 or 1.
    ...
    void MoveBarInSet(int barPositionIndex, Transform moveTransform)
      ...
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: barPositionIndex is not in the range [ 0, NumberOfBarPositions-1 ]. -or- moveTransform is not conformal.
    ...
    void SetHookOrientation(int iEnd, RebarHookOrientation hookOrientation)
      ...
      Throws ArgumentOutOfRangeException: iEnd must be 0 or 1. -or- A value passed for an enumeration argument is not a member of that enumeration
...
Implements: IDisposable
  ...
  METHODS:
    ...
    void SetPreferredConstraintForHandle(RebarConstrainedHandle handle, RebarConstraint constraint)
      ...
      Throws ArgumentException: constraint is no longer valid. -or- handle is no longer valid. -or- The input handle should be equal to the one for which the constraint is.
      Throws ArgumentNullException: A non-optional argument was null
      Throws InvalidOperationException: The RebarConstraintsManager does not manage a valid Rebar element.
...
Implements: IEnumerable<RebarContainerItem>, IEnumerable
  ...
  METHODS:
    ...
    RebarContainerItem AppendItemFromRebar(Rebar rebar)
      ...
      @rebar: The Rebar.
      Returns: The Rebar Container Item.
      Throws ArgumentException: The RebarShape of rebar has End Treatments -or- Can't create container from free-form rebar. -or- Can't create container from Rebar with moved bars.
      Throws ArgumentNullException: A non-optional argument was null
    RebarContainerItem AppendItemFromRebarShape(RebarShape rebarShape, RebarBarType barType, XYZ origin, XYZ xVector, XYZ yVector)
      ...
      Returns: The Rebar Container Item.
      Throws ArgumentException: The rebarShape has End Treatments
      Throws ArgumentNullException: A non-optional argument was null
...
Implements: IDisposable
  ...
  METHODS:
    ...
    void SetFromRebar(Rebar rebar)
      ...
      @rebar: The Rebar.
      Throws ArgumentException: The RebarShape of rebar has End Treatments -or- Can't create container from free-form rebar. -or- Can't create container from Rebar with moved bars. -or- Can't create container from Rebar which has excluded bars other than the first and last one.
      Throws ArgumentNullException: A non-optional argument was null
...
Implements: IDisposable
  ...
  METHODS:
    ...
    void SetHookPlaneNormalForBarIdx(int end, int barPositionIndex, XYZ hookNormal)
      ...
      Throws ArgumentException: Normal hookNormal for end end isn't a valid normal for bar with index barPositionIndex
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: barPositionIndex is not in the range [ 0, NumberOfBarPositions-1 ]. -or- Invalid end. -or- hookNormal has zero length.
      Throws InvalidOperationException: This RebarFreeFormAccessor Rebar is constrained.
...
Inherits: ElementType
  ...
  METHODS:
    static RebarHookType Create(Document doc, double angle, double multiplier)
      ...
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: angle must be greater than 0 and no more than pi. -or- multiplier must be greater than 0 and no more than 99.
...
Inherits: ElementType
  ...
  METHODS:
    ...
    int GetDefaultHookAngle(int index)
      ...
      Throws ArgumentOutOfRangeException: index must be 0 or 1.
    ...
    ElementId GetEndTreatmentTypeId(int iEnd)
      ...
      Throws ArgumentException: iEnd not a valid shape end
    double GetHookRotationAngle(int iEnd)
      Description: Gets the out of plane hook rotation angle at the specified end.
      @iEnd: 0 for the start , 1 for the end.
      Returns: Returns the out of plane hook rotation angle at the specified end.
    ...
    void SetEndTreatmentTypeId(ElementId endTreatmentId, int iEnd)
      ...
      @iEnd: 0 for the start end treatment, 1 for the end end treatment.
      Throws ArgumentException: iEnd not a valid shape end -or- the parameter endTreatmentId is not an EndTreatmentType element.
      Throws ArgumentNullException: A non-optional argument was null
    void SetHookRotationAngle(double hookRotationAngle, int iEnd)
      Description: Sets the out of plane hook rotation angle at the specified end.
      @hookRotationAngle: The out of plane hook rotation angle at the specified end.
...
Implements: IDisposable
  ...
  METHODS:
    void AddFormulaParameter(ElementId paramId, string formula)
      ...
      Throws ArgumentException: paramId is not the id of a shared parameter in the current document, or its unit type is not UT_Reinforcement_Length or UT_Angle. -or- The name of a shared parameter identified by paramId was already used by another shared parameter of the element.
      Throws ArgumentNullException: A non-optional argument was null
...
Inherits: RebarShapeDefinition
  ...
  METHODS:
    ...
    void AddBendVariableRadius(int vertexIndex, RebarShapeVertexTurn turn, RebarShapeBendAngle angle, ElementId paramId, bool measureIncludingBarThickness)
      ...
      Throws ArgumentException: vertexIndex is not between 0 and NumberOfVertices. -or- paramId is not the id of a shared parameter in the current document, or its unit type is not UT_Reinforcement_Length or UT_Angle.
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: A value passed for an enumeration argument is not a member of that enumeration
    void AddConstraintParallelToSegment(int iSegment, ElementId paramId, bool measureToOutsideOfBend0, bool measureToOutsideOfBend1)
      ...
      Throws ArgumentException: iSegment is not between 0 and NumberOfSegments. -or- paramId is not the id of a shared parameter in the current document, or its unit type is not UT_Reinforcement_Length or UT_Angle.
      Throws ArgumentNullException: A non-optional argument was null
    ...
    void AddListeningDimensionBendToBend(ElementId paramId, double constraintDirCoordX, double constraintDirCoordY, int iSegment0, int iEnd0, int iSegment1, int iEnd1)
      ...
      Throws ArgumentException: paramId is not the id of a shared parameter in the current document, or its unit type is not UT_Reinforcement_Length or UT_Angle. -or- The length of the vector (constraintDirCoordX, constraintDirCoordY) is too close to zero. -or- iSegment0 is not between 0 and NumberOfSegments. -or- iEnd0 is neither 0 nor 1. -or- iSegment1 is not between 0 and NumberOfSegments. -or- iEnd1 is neither 0 nor 1.
      Throws ArgumentNullException: A non-optional argument was null
...
Implements: IDisposable
  ...
  METHODS:
    ...
    void SetHookPlaneNormalForBarIdx(int end, int barPositionIndex, XYZ hookNormal)
      ...
      Throws ArgumentNullException: A non-optional argument was null
      Throws ArgumentOutOfRangeException: Invalid end. -or- hookNormal has zero length.
