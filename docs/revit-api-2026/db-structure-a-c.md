...
Description: This enum represents the values that custom handles tags of RebarConstrainedHandle of Rebar Free Form Aligned Distribution has. The tag of a Autodesk::Revit::DB::Structure::RebarHandleType::CustomHandle RebarConstrainedHandle can be obtained by calling the Autodesk::Revit::DB::Structure::RebarConstrainedHandle::GetCustomHandleTag
Inherits: Enum
