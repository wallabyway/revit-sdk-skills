...
Implements: IDisposable
  ...
  METHODS:
    ...
    void Dispose()
    Color GetColor()
      Description: Gets the color of the handle and the associated DirectContext3D graphics.
      Returns: The color.
    int GetTransparency()
    ...
    void SetColor(Color color)
      Description: Sets the color of the handle and the associated DirectContext3D graphics.
