...
Implements: IDisposable
  ...
  PROPERTIES:
    ...
    IFCLinkOrientation LinkOrientation { get; set; }
      Description: The orientation of the Linked IFC File in the Host Document.
    IFCLinkPosition LinkPosition { get; set; }
      Description: The position of the Linked IFC File in the Host Document.
...
[ENUM] IFCLinkOrientation
Full Name: Autodesk.Revit.DB.IFC.IFCLinkOrientation
Description: IFC Link Orientation within the Host Document.
Inherits: Enum
...
[ENUM] IFCLinkPosition
Full Name: Autodesk.Revit.DB.IFC.IFCLinkPosition
Description: IFC Link Position within the Host Document.
Inherits: Enum
