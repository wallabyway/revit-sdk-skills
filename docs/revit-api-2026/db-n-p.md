...
Description: A class to support assigning numbers to elements of a particular kind for the purpose of tagging and scheduling them. Complete configuration settings for formatting.
...
[ERROR DOCUMENTING TYPE] PointCloudType: Could not load file or assembly 'AdskRcManaged, Version=1.0.9151.24030, Culture=neutral, PublicKeyToken=null'. O sistema não pode encontrar o arquivo especificado.
...
Remarks: See also: PolylineSegments).
Implements: IDisposable
